...
- Sample Multi-version installation
   ...
   ```shell
   sudo apt install rocm-hip-sdk5.3 rocm-hip-sdk5.2.3
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo yum install rocm-hip-sdk5.3 rocm-hip-sdk5.2.3
   ```
...
- Sample Multi-version installation
   ...
   ```shell
   sudo zypper --gpg-auto-import-keys install rocm-hip-sdk5.3 rocm-hip-sdk5.2.3
   ```
...
2. Add binary paths to the `PATH` environment variable.
   ...
   ```shell
   export PATH=$PATH:/opt/rocm-5.3/bin:/opt/rocm-5.3/opencl/bin
   ```
