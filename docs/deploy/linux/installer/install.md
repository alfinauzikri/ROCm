...
sudo apt install ./amdgpu-install_5.3.50400-1_all.deb
```
...
sudo apt install ./amdgpu-install_5.3.50501-1_all.deb
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.3/rhel/8.8/amdgpu-install-5.3.50300-1.el8.noarch.rpm
```
...
```shell
sudo yum install https://repo.radeon.com/amdgpu-install/5.3/rhel/9.2/amdgpu-install-5.3.5030-1.el8.noarch.rpm
```
...
**Example:** If you want to install ROCm releases 5.2.3 and 5.3
...
sudo amdgpu-install --usecase=rocm --rocmrelease=5.3
```
